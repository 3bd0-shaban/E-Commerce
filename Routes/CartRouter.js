...
import { Add_New_Cart, Find_Items_In_Cart, Delete_Items_In_Cart, Delete_Specific_Item_In_Cart, Increment, Decrement } from '../Controllers/CartController.js';
...
Router.post('/deleteall', auth, Delete_Items_In_Cart);
