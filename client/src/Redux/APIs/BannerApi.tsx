...
export const BannerApi = apiSlice.injectEndpoints({
    endpoints: (builder) => ({
        getBanner: builder.query<bannerType[], void>({
            query: () => ({
                url: '/api/banner/',
        ...
        getBannerTop: builder.query<bannerType[], void>({
            query: () => ({
                url: '/api/banner/top',
            }),
            providesTags: ['Banner'],
        }),
        getBannerSide: builder.query<bannerType[], void>({
            query: () => ({
                url: '/api/banner/side',
            }),
            providesTags: ['Banner'],
        }),
        getBannerDetails: builder.query<bannerType, void>({
