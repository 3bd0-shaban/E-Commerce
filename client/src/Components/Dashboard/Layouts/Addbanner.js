...
const Addbanner = () => {
        ...
        return (
            <>
                <form onSubmit={props.onSubmit} className='p-5'>
                    ...
                    <AddImage onChange={HandleImages} />
                    <div className=''>
    ...
    return (
        <>
            {error && <Danger error={error.data.msg} className={'container max-w-full my-5'} />}
            {isSuccess && <Success error={'Banner uploaded Successfully'} className={'container max-w-full my-5'} />}
            <div className='flex'>
                <div className='container px-0 max-w-full mt-5'>
                    ...
                    <div className='grid grid-cols-1 xl:grid-cols-4 gap-5 my-8'>
                        <div className='xl:col-span-1 border rounded-lg'>
                            <From onSubmit={HandleSubmit} Title={'Add Side Images'} />
                        </div>
