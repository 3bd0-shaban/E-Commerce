...
import { AddImage, ModalConfirm, useBreakpoint } from '../../../Exports';
...
const CategoryInfo = (props) => {
    ...
    const breakoint = useBreakpoint();
    const ismobile = breakoint === 'xs' || breakoint === 'sm';
            ...
            >
                ...
                <div className='overflow-y-auto'>
                    ...
                    {CategoryDetails && <div className='mx-16'>
                        ...
                        <button
                            onClick={() => dispatch(FeaturesAction.Show_ModalConfirm(true))}
