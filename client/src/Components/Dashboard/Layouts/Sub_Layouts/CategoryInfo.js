...
const CategoryInfo = (props) => {
    ...
    }, [CategoryDetails.image, setOldImage]);
    const HandleUpdate_Submit = (event) => {
        event.preventDefault();
        const id = CategoryDetails._id
        // const { category, des } = inputs;
        dispatch(Update_Category(id, category, des, image, nameOfSub))
    }
                ...
                <div className='overflow-y-auto'>
                    ...
                    <form onSubmit={HandleUpdate_Submit} >
                        <div className='mx-16'>
                            ...
                            <button className='bg-blue-500 rounded-md text-base font-semibold text-white px-4 py-2 mb-3 focus:bg-blue-400 absolute top-0 right-0 mt-5 mr-10'>Save Changes</button>
                        </div>
                    </form>
                </div>
            </div>
