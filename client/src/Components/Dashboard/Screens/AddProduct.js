...
import { PreviewImege, AddImage, Category, useTitle, Editor } from '../../Exports'
...
const AddProduct = () => {
    ...
    return (
        <>
            ...
            <div className='container max-w-full px-1 select-none'>
                ...
                <div className='container px-0 max-w-[120rem]'>
                    <p className='text-sm text-gray-400'>Dashboard / Product / Add Product</p>
                    <p className='text-xl font-semibold py-3'>Add New Product</p>
                    <form
                        onSubmit={handleSubmit}
                        id='submit'
                        className='rounded-xl h-full'>
                        <div className='grid grid-cols-1 xl:grid-cols-6 xl:gap-8'>
                            <div className='col-span-4 space-y-5'>
                                <div className='sm:shadow-[.2px_.2px_3px_1px] sm:shadow-gray-200  rounded-lg lg:px-5 xl:px-10  py-5'>
                                ...
                                <div className='col-span-2 rounded-lg sm:shadow-[.2px_.2px_3px_1px] sm:shadow-gray-200  xl:py-5 lg:px-5 xl:px-6 xxl:px-10'>
                                ...
                                {more &&
                                    <div className='xl:border mt-5 rounded-lg lg:px-5 xl:px-10 py-5'>
                                        <p className='mb-5 text-base font-Rubik text-gray-500 font-light'>
                                            This part is an optainal for product , you can apply all field or just one</p>
                                        ...
                                        <button
                                            ...
                                            {isLoading ?
                                                <span
                                                    className='flex items-center justify-center text-2xl py-1 animate-spin cursor-progress'>
                                                    <ImSpinner7 />
                                                </span> : 'Submit'}
                                        </button>
                                    </div>}
